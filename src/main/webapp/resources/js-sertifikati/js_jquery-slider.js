/* ;(function($, f) { // Problem between OLD and NEW slider APril 2016 // */
$(function($, f) {
	//  If there's no jQuery, slider can't work, so kill the operation.
	if(!$) return f;
	...
	var slider = function() {
		...
		this.move = function(index, cb) {
			...
			// action when start sliding
			_.opts.starting(_.el);
