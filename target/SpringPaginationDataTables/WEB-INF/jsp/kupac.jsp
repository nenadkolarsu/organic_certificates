...
<%@ include file="top.jsp" %>
 ...
 <center>
                ...
                <h2>Pregled sertifikata za ${naziv}</h2>
                  ...
                  <!--          <th> Adresa </th>
                    ...
                    <c:forEach items="${kupac}" var="user">
                        <tr>
                            ...
                            <td align="center"><a href="prikazSertifikata.web?id=1"><img src="https://hikashop.com/media/com_hikashop/upload/thumbnails/210x210/pdf.png" width="40" height="30" /></a> </td>
        ...
        <img src="http://www.tizag.com/pics/htmlT/ahman.gif" class="linksESPN" />
                 ...
                 -->
                            ...
                            <tr>
                                ...
                                <td></td>
                                 <td>
                                               <a href="<c:url value="/kupacAdd.htm"></c:url>">Dodaj sertifikat</a> 
                                </td>
                            </tr>
